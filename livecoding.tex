...
\begin{frame}
  ...
  \only<1>{
    ...
    \includegraphics[width=\textwidth]{images/env-release.png}
  ...
  \only<2>{
    ...
    \includegraphics[width=\textwidth]{images/env-attack-release.png}
  ...
  \only<3>{
    ...
    \includegraphics[width=\textwidth]{images/env-attack-sustain-release.png}
  ...
  \only<4>{
    ...
    \includegraphics[width=\textwidth]{images/env-attack-decay-sustain-release.png}
